...
FACILITY_CONFIG = {
    # 45番: 範囲を広げる (縮尺が狭すぎた)
    45: {'scale': 3.0, 'zoom': 18},  # 300%に拡大

    # 65,66,67番: 範囲を狭める (近接していて混同)
    65: {'scale': 1.5, 'zoom': 18, 'offset_lon': 0.001},   # 東寄り
    66: {'scale': 1.5, 'zoom': 18, 'offset_lon': -0.001},  # 西寄り
    67: {'scale': 1.5, 'zoom': 18, 'offset_lat': -0.001, 'offset_lon': -0.0005},  # 南西寄り
